...
// TODO: make isuserexist to use %like operator
	...
	GetMessagesQuery = `
	SELECT m.message_id, m.sender_id, u.username, u.name, m.content, m.timestamp, m.chat_room_id, m.is_dm, m.type, COALESCE(r.read_at, '1970-01-01T00:00:00Z') AS read_at 
	FROM messages m 
